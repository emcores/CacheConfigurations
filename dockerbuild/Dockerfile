FROM ubuntu:xenial
RUN apt-get update \
    &&  apt-get install -y gettext wget git automake build-essential scons python-dev libprotobuf-dev python-protobuf protobuf-compiler libgoogle-perftools-dev
